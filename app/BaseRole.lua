...
local BaseRole = class("BaseRole", function()
...
function BaseRole:ctor()
    ...
    local eventss = {
        ...
        {name = "attack",  from = "attack_4",  to = "attack_1"},
    }
    for i = 2,4 do
...
function BaseRole:update()
    self.timer = self.timer + 1
end

-- function BaseRole:updatePosition(dt)
--     if  self:getState() == "run" then
--         self:setPosition(self:getPositionX()+2.0,self:getPositionY())
--     end
